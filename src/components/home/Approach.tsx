...
const Approach = () => {
  return (
    <section className="w-full pt-20 pb-10" id="Approach">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        ...
        <Card
          title={approaches.phase3.title}
          icon={<AceternityIcon order="Phase 3" />}
          desc={approaches.phase3.desc}
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="group/canvas-card relative mx-auto flex w-full max-w-sm items-center justify-center border border-black/[0.2] p-4 lg:h-[35rem] dark:border-white/[0.2]"
    >
      ...
      <div className="relative z-20">
        <div className="absolute top-[50%] left-[50%] mx-auto flex w-full -translate-1/2 items-center justify-center text-center transition duration-200 group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0">
          {icon}
        </div>
